...
import { officerActivities } from '@/data/officerActivities';
...
const StatBox: React.FC<StatBoxProps> = ({ value, label, className }) => (
  <div className={cn(
    'px-3 py-1.5 rounded-lg text-center flex items-center gap-1.5',
    className
  )}>
...
export const ActivityDashboard: React.FC = () => {
  ...
  const totalStats = officerActivities.reduce(
    (acc, group) => ({
