...
interface PreviewConsentFormModalProps {
  isOpen: boolean;
  onClose: () => void;
}

const PreviewConsentFormModal: React.FC<PreviewConsentFormModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
      <div className="relative mx-auto my-6 p-5 border w-full max-w-5xl shadow-lg rounded-md bg-white">
        <div className="flex justify-between items-start pb-3 border-b border-gray-200">
          <h3 className="text-xl font-semibold text-gray-900">
            Officer Consent Form Template
          </h3>
          <button 
            onClick={onClose}
          ...
          <div className="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-200">
            ...
            <div className="px-6 py-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* First Name */}
                <div>
                  <Label htmlFor="preview_first_name" className="block text-sm font-medium text-gray-700 mb-1">
                ...
                {/* Middle Name */}
                <div>
                  <Label htmlFor="preview_middle_name" className="block text-sm font-medium text-gray-700 mb-1">
                    Middle Name(s)
                  </Label>
                  <div className="h-10 bg-gray-50 border border-gray-200 rounded-md"></div>
                </div>
                ...
                {/* Last Name */}
                <div>
                  <Label htmlFor="preview_last_name" className="block text-sm font-medium text-gray-700 mb-1">
                  ...
                  <fieldset>
                    ...
                    <div className="mt-1 space-y-2">
                      <div className="flex items-center">
                        ...
                        <label className="block text-sm text-gray-700">Yes</label>
                      </div>
                      <div className="flex items-center">
                        <div className="h-4 w-4 border border-gray-300 rounded-full mr-2"></div>
                        <label className="block text-sm text-gray-700">No</label>
                      </div>
                    </div>
                  </fieldset>
                </div>
                ...
                <div className="md:col-span-2">
                  <Label htmlFor="preview_street_address" className="block text-sm font-medium text-gray-700 mb-1">
                ...
                {/* City */}
                <div>
                  <Label htmlFor="preview_city" className="block text-sm font-medium text-gray-700 mb-1">
                ...
                {/* Postcode */}
                <div>
                  <Label htmlFor="preview_postcode" className="block text-sm font-medium text-gray-700 mb-1">
                ...
                {/* Email */}
                <div>
                  <Label htmlFor="preview_email" className="block text-sm font-medium text-gray-700 mb-1">
                ...
                {/* Date Elected */}
                <div>
                  <Label htmlFor="preview_date_elected" className="block text-sm font-medium text-gray-700 mb-1">
            ...
            <div className="px-6 py-4 border-t border-b border-gray-200">
              ...
              {/* Signature Pad */}
              <div className="mb-4">
                <Label htmlFor="preview_signature" className="block text-sm font-medium text-gray-700 mb-1">
                  Signature <span className="text-red-500">*</span>
                </Label>
                <div className="h-24 bg-gray-50 border border-gray-200 rounded-md"></div>
              </div>

              {/* Date Signed */}
              <div className="max-w-xs">
                <Label htmlFor="preview_date_signed" className="block text-sm font-medium text-gray-700 mb-1">
...
export default PreviewConsentFormModal; 