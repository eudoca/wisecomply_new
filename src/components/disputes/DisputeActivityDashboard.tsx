...
import { disputeActivities } from '@/data/disputeActivities';
import { Switch } from '@/components/ui/switch';
import { Label } from '@/components/ui/label';
import { cn } from '@/lib/utils';
import { PlusCircle, MinusCircle, AlertTriangle, Users, FileText, Folder } from 'lucide-react';
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
export const DisputeActivityDashboard: React.FC = () => {
  const [showCompleted, setShowCompleted] = useState(false);
  const [isOpen, setIsOpen] = useState(true);

  // Calculate total stats
  const totalStats = disputeActivities.reduce(
    (acc, group) => ({
