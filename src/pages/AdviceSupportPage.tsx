  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="flex items-center gap-2 mb-6">
        ...
        <h1 className="text-2xl font-semibold text-purple-600">Ask WiseComply Ai</h1>
      </div>
      ...
      <div className="mt-6 mb-6 bg-blue-50 p-4 rounded-lg border border-blue-100 flex">
        ...
        <div className="text-sm text-blue-700">
          <p>
            This page helps you get guidance and answers to your questions about society management.
          </p>
        </div>
      </div>
